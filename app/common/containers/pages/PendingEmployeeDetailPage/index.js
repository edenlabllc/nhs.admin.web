  ...
  render() {
    ...
    return (
      <div id="pending-employee-detail-page">
        ...
        <BackLink to="/pending-employees">{ t('Back to pending employees list') }</BackLink>
        ...
        <div className={styles.main}>
          <DataList
            list={[
              ...
              { name: t('Date registration'), value: format(employee.inserted_at, 'DD/MM/YYYY') },
              { name: t('Employee type'), value: <DictionaryValue dictionary="EMPLOYEE_TYPE" value={employee.employee_type} /> },
            ]}
          />
          ...
          <div className={styles.strong}>
            <DataList
              ...
              list={[
                ...
                { name: t('Phones'), value: <InlineList list={employee.party.phones.map(item => item.number)} /> },
              ]}
            />
          </div>

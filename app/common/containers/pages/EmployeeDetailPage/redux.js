...
export const fetchEmployee = id => dispatch =>
  ...
  .then((action) => {
    ...
    return dispatch(showEmployee(action.payload.entities.employees[action.payload.result]));
  });

const employee = handleAction(showEmployee, (state, action) => action.payload, {});

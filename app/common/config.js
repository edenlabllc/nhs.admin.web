...
export const SCOPES = process.env.SCOPES || 'legal_entity:read employee:read employee_request:write employee_request:read legal_entity:nhs_verify legal_entity:deactivate';

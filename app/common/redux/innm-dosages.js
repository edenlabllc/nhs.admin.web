...
export const fetchInnmDosages = options => invoke({
  endpoint: createUrl(`${API_URL}/api/innm_dosages`, options),
  method: 'GET',
  headers: {
...
export const fetchInnmDosage = id => invoke({
  ...
  types: ['innm_dosages/FETCH_DETAILS_REQUEST', {
